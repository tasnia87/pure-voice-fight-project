<div id="snc-media_upload_file_wrap" class="wrap snc_TB">
	...
	<form enctype="multipart/form-data" id="snc-media_upload_file_form" action="<?php echo admin_url( 'admin-ajax.php' ) ?>" method="POST">
		...
		<p class="description">
			<a href="http://www.elearningfreak.com/uncategorized/increase-maximum-upload-file-size/" target="_blank"><?php _e( 'Maximum upload file size', 'uncanny-learndash-reporting' ); ?></a>: <strong><?php echo $this->format_bytes( wp_max_upload_size() ); ?></strong>
		</p>
