...
class QuizModuleReports extends Config {
	...
	public function user_quiz_report() {
		...
		AND course_id IN ($course_ids_string)
		AND verb IN ( 'failed','passed', 'completed' )
		AND `result` IS NOT NULL";
		...
		<div class="uotc-report__header">
			...
			<div class="uotc-report__buttons">
				<div class="uotc-report__btn uotc-report__btn--csv"><?php echo __( 'CSV', 'uncanny-learndash-reporting' ); ?></div>
				<div class="uotc-report__btn uotc-report__btn--pdf"><?php echo __( 'PDF', 'uncanny-learndash-reporting' ); ?></div>
			</div>
		</div>
