...
class Database {
	...
	private function create_table_uotincan_quiz() {
		...
		$query = sprintf( "CREATE TABLE %s%s (
					...
					PRIMARY KEY (`id`),
					CONSTRAINT `fk_TinCanQuizUser`   FOREIGN KEY(`user_id`)   REFERENCES {$wpdb->users}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE,
					CONSTRAINT `fk_TinCanQuizGroup`  FOREIGN KEY(`group_id`)  REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE,
					CONSTRAINT `fk_TinCanQuizCourse` FOREIGN KEY(`course_id`) REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE,
					CONSTRAINT `fk_TinCanQuizLesson` FOREIGN KEY(`lesson_id`) REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE
	...
	public static function update_constraints($table_name){
		...
		if ( $table_name === self::TABLE_REPORTING ) {
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_REPORTING . " ADD CONSTRAINT `fk_TinCanUser`   FOREIGN KEY(`user_id`)   REFERENCES {$wpdb->users}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_REPORTING . " ADD CONSTRAINT `fk_TinCanGroup`   FOREIGN KEY(`group_id`)   REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_REPORTING . " ADD CONSTRAINT `fk_TinCanCourse`   FOREIGN KEY(`course_id`)   REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_REPORTING . " ADD CONSTRAINT `fk_TinCanLesson`   FOREIGN KEY(`lesson_id`)   REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_RESUME . " ADD CONSTRAINT `fk_Resume_User`   FOREIGN KEY(`user_id`)   REFERENCES {$wpdb->users}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_RESUME . " ADD CONSTRAINT `fk_Resume_Module`   FOREIGN KEY(`module_id`)   REFERENCES " . $wpdb->prefix . SnC_TABLE_NAME . "(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_QUIZ . " ADD CONSTRAINT `fk_TinCanQuizUser`   FOREIGN KEY(`user_id`)   REFERENCES {$wpdb->users}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_QUIZ . " ADD CONSTRAINT `fk_TinCanQuizGroup`   FOREIGN KEY(`group_id`)   REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_QUIZ . " ADD CONSTRAINT `fk_TinCanQuizCourse`   FOREIGN KEY(`course_id`)   REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
			...
			$wpdb->query( " ALTER TABLE " . $wpdb->prefix . self::TABLE_QUIZ . " ADD CONSTRAINT `fk_TinCanQuizLesson`   FOREIGN KEY(`lesson_id`)   REFERENCES {$wpdb->posts}(`ID`) ON UPDATE CASCADE ON DELETE CASCADE" );
		}
	}
