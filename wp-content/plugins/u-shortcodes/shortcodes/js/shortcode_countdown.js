			...
			onclick: function() {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[u_countdown year="'+e.data.year+'" month="'+e.data.month+'" day="'+e.data.day+'" hour="'+e.data.hour+'" minute="'+e.data.minute+'" bg_color="'+e.data.bg_color+'" num_color="'+e.data.num_color+'" show_second="'+e.data.show_second+'" css_animation="'+e.data.css_animation+'" animation_delay="'+e.data.animation_delay+'"]<br class="nc"/>');
					}
				});
			}
		});
