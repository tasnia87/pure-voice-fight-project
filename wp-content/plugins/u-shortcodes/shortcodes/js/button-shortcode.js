// JavaScript Document
(function() {
    tinymce.PluginManager.add('shortcode_button_cactus', function(editor, url) {
		editor.addButton('shortcode_button_cactus', {
			text: '',
			tooltip: 'Shortcode',
			id: 'bt_listshortcode',
			icon: 'icons',
			onclick: function() {
				...
				editor.windowManager.open({
					...
					body: [
						...
						{type: 'button', name: 'Video Banner', text: 'Video Banner', label: 'Video Banner' , id: 'id_shortcode_video_banner'},
						{type: 'button', name: 'Compare table', text: 'Compare table', label: 'Compare table' , id: 'id_shortcode_comparetable'},
					],
				});
			}
		});
