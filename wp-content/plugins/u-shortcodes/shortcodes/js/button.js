			...
			onclick: function() {
				...
				editor.windowManager.open({
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[ct_button id="button_'+uID+'" size="'+e.data.size+'" solid="'+e.data.solid+'" link="'+e.data.links+'" icon="'+e.data.icon+'" arrow="'+e.data.arrow+'" color="'+e.data.bgcolor+'" css_animation="'+e.data.css_animation+'" animation_delay="'+e.data.animation_delay+'"]'+e.data.label+'[/ct_button]<br class="nc"/>');
					}
				});
			}
		});
