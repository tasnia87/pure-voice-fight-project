...
<div class="woocommerce-billing-fields">
	...
	<?php else : ?>
		...
		<h2><?php esc_html_e( 'Billing Info', 'cactusthemes' ); ?></h2>
...
<div class="btn-continue billing">
    <span class="btn btn-primary btn-lg btn-block" id="billinginfo_uni"><?php esc_html_e( 'Continue', 'cactusthemes' ); ?></span>
</div>