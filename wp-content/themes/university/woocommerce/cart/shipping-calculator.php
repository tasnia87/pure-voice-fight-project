...
<form class="woocommerce-shipping-calculator shipping_calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <?php printf( '<h2><a href="#" class="shipping-calculator-button main-color-1-hover">%s<i class="fa fa-long-arrow-right"></i></a></h2>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
